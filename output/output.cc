...
Class __B::__class() {
static Class k =
new __Class(__rt::literal("null.B"), (Class) __rt::null());
return k;
}
...
Class __C::__class() {
static Class k =
new __Class(__rt::literal("null.C"), (Class) __rt::null());
return k;
}
...
void __Overloaded::m_byte(unsigned char b) {
cout << "m(byte)    : " << (int)b <<endl;
...
cout << "m(A,A)     : " << a1->__vptr->toString(a1)->data << ", " << a2->__vptr->toString(a2)->data <<endl;

}
void __Overloaded::m_A_B(A a1, B b2) {
cout << "m(A,B)     : " << a1->__vptr->toString(a1)->data << ", " << b2->__vptr->toString(b2)->data <<endl;

}
void __Overloaded::m_B_A(B b1, A a2) {
cout << "m(B,A)     : " << b1->__vptr->toString(b1)->data << ", " << a2->__vptr->toString(a2)->data <<endl;

}
void __Overloaded::m_C_C(C c1, C c2) {
cout << "m(C,C)     : " << c1->__vptr->toString(c1)->data << ", " << c2->__vptr->toString(c2)->data <<endl;
...
static Class k =
new __Class(__rt::literal("null.Overloaded"), (Class) __rt::null());
return k;
}
